...
void HtmlReporter::printSummary(ofstream& ofs, FilterResult* result, Stats* preStats1, Stats* postStats1, Stats* preStats2, Stats* postStats2) {
    ...
    ofs << endl;
    ofs << "<h1 style='text-align:left;'><a href='https://gitlab.genomics.cn/liuxing2/stlfrfastp' target='_blank' style='color:#663355;text-decoration:none;'>" + mOptions->reportTitle + "</a>"<<endl;
    ...
    outputRow(ofs, "fastp version:", string(FASTP_VER)+ " (<a href='https://gitlab.genomics.cn/liuxing2/stlfrfastp'>https://gitlab.genomics.cn/liuxing2/stlfrfastp</a>)");
